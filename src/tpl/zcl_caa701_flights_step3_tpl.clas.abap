class zcl_caa701_flights_step3_tpl definition public final create public .
...
class zcl_caa701_flights_step3_tpl implementation.
  ...
  method get_pet_availability.
    ...
    "-----------------------------------------------------------------------------------------------------------------------
    " STEP 3 - Conditional Table Reduction
    "
  ...
  method compute_average_price.
    ...
    "-----------------------------------------------------------------------------------------------------------------------
    " STEP 3 - Table Comprehension grouping
    " Remove all variables and types definitions
    "-----------------------------------------------------------------------------------------------------------------------
    types:
      begin of ty_flights,
        carrid type zcaa701_carrid,
